    ...
    <>
      <div className="w-72 shadow-md min-h-screen max-h-fit bg-gray-50">
        ...
        <div className="mt-10">
          ...
          <NavMenu icon="ri-user-2-line" name="student" link="/student">
            <NavLink
              className={({ isActive }) =>
                isActive
          ...
          <NavMenu icon="ri-user-3-line" name="Teacher" link="/teacher">
            <NavLink
              className={({ isActive }) =>
                isActive
                  ? "pl-10 border-l-4  border-l-red-500 px-3 my-5 text-red-500 flex items-center"
          ...
          <NavMenu icon="ri-user-3-line" name="Guardian" link="/guardian">
            <NavLink
              className={({ isActive }) => 
                isActive
                  ? "pl-10 border-l-4  border-l-red-500 px-3 my-5 text-red-500 flex items-center"
          ...
          <NavMenu icon="ri-user-2-line" name="Subject" link="/subject">
            <NavLink
              className={({ isActive }) =>
                isActive
                  ? "pl-10 border-l-4  border-l-red-500 px-3 my-5 text-red-500 flex items-center"
