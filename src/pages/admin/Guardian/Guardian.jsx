    ...
    <div>
        ...
        <div className="px-10 py-6 w-full">
          <div className="flex justify-between">
            <h1 className="text-4xl text-gray-700">Guardians list</h1>
          ...
          <div className="card-body">
            <table class="border-collapse border border-slate-400 w-full ">
              <thead>
                <tr>
                <th class="border border-slate-300 px-2 ">SNo.</th>
                <th class="border border-slate-300 px-2 ">Guardian name </th>
                <th class="border border-slate-300 px-2 ">Phone No.</th>
                <th class="border border-slate-300 px-2 ">Action</th>
                  
                </tr>
              </thead>
              <tbody>
                <tr>
                <td class="border border-slate-300 px-2 ...">Indiana</td>
                  <td class="border border-slate-300 px-2 ...">Indiana</td>
                  <td class="border border-slate-300 px-2 ...">Indianapolis</td>
